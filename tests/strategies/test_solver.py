...
def test_solver_finds_short_solution():
    ...
    engine.target_state = {
        (0, 0): MoraColor.YELLOW, (0, 4): MoraColor.GREY,
        (4, 4): MoraColor.GREY,   (4, 0): MoraColor.GREY
    }
    ...
    engine.board_state = {
        (1, 1): MoraColor.WHITE,  (1, 2): MoraColor.GREY, (1, 3): MoraColor.GREY,
        (2, 1): MoraColor.YELLOW, (2, 2): MoraColor.GREY, (2, 3): MoraColor.GREY,
        (3, 1): MoraColor.GREY,   (3, 2): MoraColor.GREY, (3, 3): MoraColor.GREY
    }
